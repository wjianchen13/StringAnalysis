package com.example.stringanalysis.sensitivewdfilter;

import android.content.Context;

import com.example.stringanalysis.sensitivewdfilter.util.BCConvert;
...
//	}
	...
	public static void init(Context context) {
		// 获取敏感词
		addSensitiveWord(readWordFromFile(context, "wd.txt"));
		addStopWord(readWordFromFile(context, "stopwd.txt"));
	}
	 ...
	 * @return
	 */
	private static List<String> readWordFromFile(Context context, String path) {
		List<String> words;
		BufferedReader br = null;
		if(context == null)
			return null;
		try {
			br = new BufferedReader(new InputStreamReader(context.getResources().getAssets().open(path)));
